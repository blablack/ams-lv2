...
Mixer8ChGUI::Mixer8ChGUI(const std::string& URI)
{
	...
	m_dialGain = new LabeledDial("Gain", p_gain, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume1 = new LabeledDial("Volume 1", p_volume1, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume2 = new LabeledDial("Volume 2", p_volume2, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume3 = new LabeledDial("Volume 3", p_volume3, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume4 = new LabeledDial("Volume 4", p_volume4, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume5 = new LabeledDial("Volume 5", p_volume5, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume6 = new LabeledDial("Volume 6", p_volume6, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume7 = new LabeledDial("Volume 7", p_volume7, 0, 2, NORMAL, 0.01);
	...
	m_dialVolume8 = new LabeledDial("Volume 8", p_volume8, 0, 2, NORMAL, 0.01);
