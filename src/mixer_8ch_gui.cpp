...
Mixer8ChGUI::Mixer8ChGUI(const std::string& URI)
{
    ...
    m_dialVolume5 = new LabeledDial("Volume 5", p_volume5, 0, 2, NORMAL, 0.01, 2);
    ...
    m_dialVolume6 = new LabeledDial("Volume 6", p_volume6, 0, 2, NORMAL, 0.01, 2);
    ...
    m_dialVolume7 = new LabeledDial("Volume 7", p_volume7, 0, 2, NORMAL, 0.01, 2);
    ...
    m_dialVolume8 = new LabeledDial("Volume 8", p_volume8, 0, 2, NORMAL, 0.01, 2);
