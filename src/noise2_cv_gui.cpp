...
Noise2CVGUI::Noise2CVGUI(const std::string& URI)
{
    ...
    m_comboNoiseForm->signal_changed().connect(compose(bind<0> (mem_fun(*this, &Noise2CVGUI::write_control), p_noiseType), mem_fun(*m_comboNoiseForm, &ComboBoxText::get_active_row_number)));
